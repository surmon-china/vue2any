<div id="app" show="true123213" class="app aaa"><?php if($PHPDATA['test']['test']): ?>
	<div>
		<div attrs="<?php echo $PHPDATA['attrs']; ?>">
			<div>i'm hello</div>
			<div class="sss">你好
				<?php echo $PHPDATA['test']; ?></div>
			<p></p>
		</div>
	</div>
<?php else: ?>
		...
		<div>
			...
			<div>
				...
				<div>
					...
					<span>i am component content</span></div><?php endforeach; ?>
				<div>
					<span>i am 1</span></div>
				<div>
					<span>i am 2</span></div>
				<div>
					<span>i am 3</span></div>
				<div>
					<span>i am 4</span></div>
				<div>
					<span>i am 5</span></div>
...
<?php else: ?><?php endif; ?>
	...
	<div class="component-list"><?php foreach ($PHPDATA['his'] as $item):?>
		<div>
			...
			<p><?php echo strip_tags($item['items']['name']); ?></p>
	...
	<ul class="php-transition-group">
		...
		<div trnasfer="group">
			...
			<div>
				<?php echo $child['abc']; ?>
				<span>666666</span></div><?php endforeach; ?></div>
		<?php endforeach; ?>
	</ul>
</div>